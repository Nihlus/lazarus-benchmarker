...
__declspec(dllexport) void lzInvertMatrixByPtr(Matrix2* matrix)
{
...
__declspec(dllexport) Matrix2 lzInvertMatrixByValue(Matrix2 matrix)
{
    lzInvertMatrixByPtr(&matrix);
    return matrix;
}
